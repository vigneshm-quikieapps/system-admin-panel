...
export const countries = [
  ...
  { code: "IO", label: "Br. Indian Ocean Ter" },
  ...
  { code: "CF", label: "Central African Rep" },
  { code: "TD", label: "Chad" },
  { code: "CL", label: "Chile" },
  { code: "CN", label: "China" },
  ...
  { code: "CD", label: "Congo (Dem. Rep.)" },
  { code: "CG", label: "Congo (Rep.)" },
  ...
  { code: "FK", label: "Falkland Is. (Malvinas)" },
  { code: "FO", label: "Faröe Islands" },
  { code: "FJ", label: "Fiji" },
  ...
  { code: "KP", label: "Korea (Dem. Rep.)" },
  { code: "KR", label: "Korea (Rep.)" },
  ...
  { code: "GS", label: "S. Georgia and S. Sandwich" },
  ...
  { code: "ST", label: "Sao Tomé and Principe" },
  ...
  { code: "VC", label: "St. Vincent and Grenadines" },
  { code: "SD", label: "Sudan" },
  ...
  { code: "TC", label: "Turks and Caicos Is" },
